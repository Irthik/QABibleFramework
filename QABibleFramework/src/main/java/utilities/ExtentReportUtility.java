...
public class ExtentReportUtility implements ITestListener {
	//library class of extent report
	...
	//System details
	reports.setSystemInfo("PC Name", "Irthik");
	...
	public void onTestSuccess(ITestResult result) { //when first test case pass
	...
	public void onTestFailure(ITestResult result) { //when test fails
	test = reports.createTest(result.getName());
	...
	public void onStart(ITestContext context) { //first step of execution
	configureReport();
	}


	public void onFinish(ITestContext context) { //after completion
	reports.flush(); 
	}
